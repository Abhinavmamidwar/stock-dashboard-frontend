...
// Validate ../../src/app/api/stock-data/route.ts
{
  const handler = {} as typeof import("../../src/app/api/stock-data/route.js")
  handler satisfies RouteHandlerConfig<"/api/stock-data">
}
